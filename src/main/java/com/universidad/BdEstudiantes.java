...
public class BdEstudiantes {
    ...
    public static ArrayList<Estudiante> listarEstudiantes (){
        ...
        Estudiante estudiante1 = new Estudiante(6,"Renata","Morales","FEM","15-03-1985","activo",15.3,"arquitectura","QUIM1",new ArrayList<>(Arrays.asList(materiasList.get(1),materiasList.get(2))),10);
